# Prison Escape: interactive AI film

A live, choose-your-own-escape anime film. Tell Larry what to do; an LLM judges the idea, writes the next shot, and MiniMax H3 generates it in seconds.
