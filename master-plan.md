...
| Live Video | on/off | Off = placeholder clip. **On spends MachGen credits.** |
...
- [ ] `rooftop`
- [ ] `perimeter-fence`: guard tower and searchlights
...
- [ ] **Intro master video** (H3): multi-shot prison establishing (exterior wide, searchlights, cell block wide) plus protagonist close-ups. Put it at `media/intro/intro.mp4`.
- [ ] **Intro idle loop**: protagonist close-up loop at `media/intro/intro-loop.mp4`.
